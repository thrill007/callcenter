      ...
      <profiles>
        ...
        <profile name="internal">
          ...
          <settings>
            ...
            <param name="odbc-dsn" value="freeswitch:lifeng:123456"/>
        ...
        <profile name="external">
          ...
          <!-- This profile is only for outbound registrations to providers -->
            <gateways>
              <gateway name="88851063331">
                <param name="username" value="8800200"/>
                <param name="password" value="1234"/>
                <param name="realm" value="101.132.254.102:45060"/>
                <param name="register" value="true"/>
              </gateway>
              <gateway name="lifeng-gateway">
                <param name="username" value="88851063330"/>
                <param name="password" value="1234"/>
                <param name="realm" value="$${local_ip_v4}:5160"/>
                <param name="register" value="true"/>
              </gateway>
            </gateways>
